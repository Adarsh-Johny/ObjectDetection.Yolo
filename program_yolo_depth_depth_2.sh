...
python yolov5-traffic-monitoring/train.py --img 640 --batch 8 --epochs 50 --data depth_images_depth_2.yaml --cfg yolov5-traffic-monitoring/models/custom_yolov5s.yaml --weights yolov5l.pt --cache True  --rect --workers 0 --name depth_images_2_final --multi-scale > output_${SLURM_JOB_ID}.txt
