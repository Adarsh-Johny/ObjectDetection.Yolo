...
python yolov5-traffic-monitoring/train.py --img 1280 --batch 16 --epochs 10 --data depth_images.yaml --cfg yolov5-traffic-monitoring/models/custom_yolov5s.yaml --weights yolov5s.pt --workers 1 --name kitti_yolov5s --multi-scale > output_${SLURM_JOB_ID}.txt
