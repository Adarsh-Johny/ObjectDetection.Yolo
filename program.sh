...
python ./ObjectDetection.Yolo/yolov5-traffic-monitoring/train.py --img 640 --batch 16 --epochs 1 --data depth_images.yaml --cfg models/custom_yolov5s.yaml --weights yolov5s.pt --name kitti_yolov5s > output_${SLURM_JOB_ID}.txt
