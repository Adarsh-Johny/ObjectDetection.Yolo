...
python yolov5-traffic-monitoring/train.py --img 640 --batch 8 --epochs 5 --data depth_images.yaml --cfg yolov5-traffic-monitoring/models/custom_yolov5s.yaml --weights yolov5s.pt --cache True  --rect --workers 0 --name kitti_yolov5s --multi-scale > output_${SLURM_JOB_ID}.txt
