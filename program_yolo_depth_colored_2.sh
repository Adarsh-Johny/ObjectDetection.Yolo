...
python yolov5-traffic-monitoring/train.py --img 640 --batch 8 --epochs 50 --data depth_images_colored_2.yaml --cfg yolov5-traffic-monitoring/models/custom_yolov5m_single_channel.yaml --weights yolov5-traffic-monitoring/runs/train/left_custom_yolov5m3/weights/best.pt --cache True  --rect --workers 0 --name depth_colored_images_re_trained --multi-scale > output_${SLURM_JOB_ID}.txt
