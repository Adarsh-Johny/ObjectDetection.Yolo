...
python yolov5-traffic-monitoring/train.py --img 640 --batch 8 --epochs 400 --data depth_images_colored_2.yaml --cfg yolov5-traffic-monitoring/models/custom_yolov5m_single_channel.yaml --weights yolov5l.pt --cache True  --rect --workers 0 --name depth_colored_images_2 --multi-scale > output_${SLURM_JOB_ID}.txt
