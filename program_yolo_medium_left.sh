...
python yolov5-traffic-monitoring/train.py --img 640 --batch 8 --epochs 100 --data kitti_left_images.yaml --cfg yolov5-traffic-monitoring/models/yolov5m.yaml --weights yolov5m.pt --cache True  --rect --workers 0 --name left_yolov5m --multi-scale > output_${SLURM_JOB_ID}.txt
