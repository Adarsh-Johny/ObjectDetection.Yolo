...
python yolov5-traffic-monitoring/train.py --img 640 --batch 8 --epochs 5 --data kitti_left_images.yaml --cfg yolov5-traffic-monitoring/models/custom_yolov5m.yaml --weights yolov5m.pt --cache True  --rect --workers 0 --name kitti_yolov5m --multi-scale > output_${SLURM_JOB_ID}.txt
